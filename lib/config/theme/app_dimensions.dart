...
class AppDimensions {
  ...
  // Border Radius
  static const double borderRadiusCard = 16.0; // Cards, containers
  static const double borderRadiusButton = 12.0; // Buttons, input fields
  static const double borderRadiusChip = 30.0; // Chips, badges
